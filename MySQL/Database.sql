...
('WisTOBY E-Insurance Agency', 'bmashauri704@gmail.com', '+255695426745', '+255736938643', 'Dar es Salaam', 'Pugu Kichangani', 'Tanzania', 'Tsh', 'Africa/Dar_es_Salaam', 'logo_1693120817.png', 'TZS', 'sidebar-dark', 'page-header-dark', 'sidebar-l', '', 'main-content-narrowed', 'page-header-fixed', 'xwork.min-5.7.css');
...
(1567, 'Bwire', 'Mashauri', 'Male', '+255765435392', 'Dar es Salaam', 'Pugu Kona', 'bwiremashauri5@gmail.com', '$2y$10$p0GpDhTDjjU3mZWsZbznGuTYIbPrlvQscdha9IsoClk3wnUVWRLOC', 0, 1);
